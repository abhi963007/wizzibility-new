        ...
        <div className="about-wrapper">
          <div className="about-title-wrapper">
            ...
            <div className="max-width-51">
              <p className="rebuild-text">Framevo Studio creates cinematic photography, videography, video editing, and photo editing for brands, creators, couples, and events.We capture real moments, shape them with clean visuals, and deliver stories that feel polished, personal, and memorable.</p>
            </div>
          </div>
