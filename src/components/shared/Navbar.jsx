    ...
    >
      <div className="container w-container">
        <div className="nav-wrapper">
          <NavLink to="/" className="nav-brand w-nav-brand">
            <div className="navbrand-text">Framevo</div>
            <div className="navbrand-icon-wrapper">
              <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 8 10" fill="none" className="navbrand-icon">
