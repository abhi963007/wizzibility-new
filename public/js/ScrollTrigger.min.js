...
!(function(e, t) {
    ...
    var k =
        ((Observer.prototype.init = function init(e) {
                ...
                function lf() {
                    ...
                    (T && (r || n) && T(se, e, t, me, ye),
                        ...
                        (_ && 0 < se.deltaY && _(se),
                            ...
                            (ce = se.deltaY),
                            (ye[0] = ye[1] = ye[2] = 0)),
                        (ne || re) && (z && z(se), re && (p && 1 === re && p(se), h && h(se), (re = 0)), (ne = !1)),
                        oe && !(oe = !1) && Z && Z(se),
                        ie && (q(se), (ie = !1)),
                        (ee = 0));
                }
                ...
                function nf(e, t) {
                    ($ && !ae && ((se.axis = ae = Math.abs(e) > Math.abs(t) ? "x" : "y"), (oe = !0)),
    ...
    function Ra(e, t) {
        ...
        return Math.max(
            0,
            (r = "scroll" + n) && (o = z(e, r)) ? o() - Oa(e)()[i] : Ma(e) ? (qe[r] || He[r]) - Na(n) : e[r] - e["offset" + n]
        );
    }
    ...
    function Db(e, t) {
        if (ct(e)) {
            ...
            (~r && (e.indexOf("%") > r && (n *= t / 100), (e = e.substr(0, r - 1))),
                (e = n + (e in U ? U[e] * t : ~e.indexOf("%") ? (parseFloat(e) * t) / 100 : parseFloat(e) || 0)));
        }
        return e;
    }
    ...
    function Kb() {
        ...
        (Ie.cache++, v ? (R = R || requestAnimationFrame($)) : $(), st || V("scrollStart"), (st = at()));
    }
    ...
    function _b(t) {
        return We(".gsap-marker-start, .gsap-marker-end, .gsap-marker-scroller-start, .gsap-marker-scroller-end").forEach(
            function(e) {
    ...
    function oc(e, t, r, n, i, o, a, s, l, c, u, f, d, p) {
        ...
        if ((d && d.seek(0), isNaN(e) || (e = +e), Va(e)))
            (d && (e = Fe.utils.mapRange(d.scrollTrigger.start, d.scrollTrigger.end, 0, f, e)), a && q(a, r, n, !0));
        else {
            Ua(t) && (t = t(s));
            var m,
                y,
        ...
        if ((p && ((s[p] = e || -0.001), e < 0 && (e = 0)), o)) {
            var S = e + r,
                T = o._isStart;
            ((g = "scroll" + n.d2),
                q(o, S, n, (T && 20 < S) || (!T && (u ? Math.max(He[g], qe[g]) : o.parentNode[g]) <= S + 1)),
        ...
        $ = function _updateAll(e) {
            if (2 === e || (!rt && !T)) {
                ...
                if (
                    ((Et = i < K ? -1 : 1),
                        rt || (K = i),
                        n && (st && !Ke && 200 < r - st && ((st = 0), V("scrollEnd")), (Ge = D), (D = r)),
                        Et < 0)
                ) {
                            ...
                            ((Wa(ue) && !ue.push) || (ue = {
                                ...
                                (te = Fe.delayedCall(ue.delay || i / 2 || 0.1, function() {
                                    var e = Ae(),
                                        t = at() - Pe < 500,
                                        r = A.tween;
                                    if (!(t || Math.abs(Te.getVelocity()) < 10) || r || Ke || Ee === e)
                                ...
                                if ((!je && Te.enabled) || t)
                                    if (ae && e && st) xb(ScrollTrigger, "scrollEnd", Pb);
                                        ...
                                        var i,
                                            ...
                                            E = k;
                                        for (we && Wa(r) && ((h = Fe.getProperty(X, he.p)), (v = Fe.getProperty(F, he.p))); 0 < E--;)
                                        ...
                                        for (
                                            ...
                                            C = Da(C, "start", Te),
                                            B =
                                            oc(C, oe, b, he, Ae(), Y, X, Te, m, Se, ye, y, de, Te._startClamp && "_startClamp") ||
                                            (ae ? -0.001 : 0),
                                            Ua(S) && (S = S(Te)),
                                            ct(S) &&
                                            !S.indexOf("+=") &&
                                            (~S.indexOf(" ") ?
                                                ...
                                                ((_ = Db(S.substr(2), b)),
                                                    (S = ct(C) ?
                                                        C :
                                                        (de ?
                                                            Fe.utils.mapRange(0, de.duration(), de.scrollTrigger.start, de.scrollTrigger.end, B) :
                                                            B) + _),
                                                    (T = oe))),
                                            S = Da(S, "end", Te),
                                            I =
                                            ...
                                            !de &&
                                            0 < c.end &&
                                            ((i = c.end - (Te._startClamp ? Math.max(0, c.start) : c.start)),
                                                ((u === oe && c.start - c._pinPush < B) || u === M) && isNaN(C) && (_ += i * (1 - c.progress)),
                                                u === ae && (w += i));
                                        if (
                                            ((B += _),
                                                (I += _),
                                                Te._startClamp && (Te._startClamp += _),
                                                Te._endClamp && !rt && ((Te._endClamp = I || -0.001), (I = Math.min(I, Ra(be, he)))),
                                                (q = I - B || ((B -= 0.01) && 0.001)),
                                                x && (Oe = Fe.utils.clamp(0, 1, Fe.utils.normalize(B, I, re))),
                                                (Te._pinPush = w),
                                                Y && _ && (((i = {})[he.a] = "+=" + _), M && (i[he.p] = "-=" + Ae()), Fe.set([Y, N], i)),
                                            ...
                                            ((i = nb(ae)),
                                                ...
                                                ((g = {
                                                    ...
                                                    me &&
                                                    "scroll" !== nb(He)["overflow" + he.a.toUpperCase()] &&
                                                ...
                                                (((Q = [se + he.os2, q + w + xt]).t = G),
                                                    ...
                                                    (Q.push(he.d, E + xt), "auto" !== G.style.flexBasis && (G.style.flexBasis = E + xt)),
                                                    Pt(Q),
                                                    M &&
                                                    Tt.forEach(function(e) {
                                        ...
                                        (p &&
                                            ...
                                            (x || Oe !== Te.progress || de || le || (O && !O._initted)) &&
                                            (O &&
                                                !ve &&
                                                (O._initted || Oe || !1 !== O.vars.immediateRender) &&
                                                O.totalProgress(de && B < -0.001 && !Oe ? Fe.utils.normalize(B, I, 0) : Oe, !0),
                                    ...
                                    if (
                                        ...
                                        (!ue || A.tween || je || ot || te.restart(!0),
                                            ...
                                            (ve &&
                                                ...
                                                (Xa(Te.callbackAnimation), ee ? ee.progress(1) : Xa(O, "reverse" === o ? 1 : !d, 1))) :
                                            ve && T && !je && T(Te));
                                    }
                                    if (x) {
                ...
                if (((Je = window), (Ue = document), (qe = Ue.documentElement), (He = Ue.body), Fe))
                    if (
                        ...
                        for (
                            ...
                            r || (He.setAttribute("style", ""), He.removeAttribute("style")),
    ...
    function Dc(e) {
        ...
        var n,
            ...
            y = 1,
            x =
            (k.isTouch && Je.visualViewport ? Je.visualViewport.scale * Je.visualViewport.width : Je.outerWidth) /
            Je.innerWidth,
            _ = 0,
            w = Ua(t) ?
            function() {
                ...
                function(e, t) {
                    if ((b.offset && Nq(), t)) {
                        ...
                        (f &&
                            ...
                            ((E && a.vars.scrollY >= o) || o - 1 <= r) && Fe.to({}, {
                                onUpdate: Tq,
                                duration: i
                            }));
                    } else s.restart(!0);
