...
!(function(t, e) {
    ...
    function Fa(t, e, r, i) {
        return (
            t._startAt &&
            (I ? t._startAt.revert(ft) : (t.vars.immediateRender && !t.vars.autoRevert) || t._startAt.render(e, !0, i))
        );
    }
    ...
    function La(t, e) {
        ...
        return (
            ...
            r.smoothChildTiming &&
            t._ts &&
            ((t._start = la(r._time - (0 < t._ts ? e / t._ts : ((t._dirty ? t.totalDuration() : t._tDur) - e) / -t._ts))),
                Ka(t),
                r._dirty || Da(r, t)),
            t
        );
    ...
    function Ma(t, e) {
        ...
        if (
            ((e._time || (!e._dur && e._initted) || (e._start < t._time && (e._dur || !e.add))) &&
                ((r = Ja(t.rawTime(), e)), (!e._dur || Mt(0, e.totalDuration(), r) - e._tTime > q) && e.render(r, !0)),
    ...
    function Pa(t, e, r, i, n) {
        return (
            Ht(t, e, n),
            t._initted ?
            !r && t._pt && !I && ((t._dur && !1 !== t.vars.lazy) || (!t._dur && t.vars.lazy)) && f !== It.frame ?
    ...
    function jb(h, e) {
        ...
        return (
            !r &&
            v(h) &&
            ((l = r = h.radius || X), h.values ? ((h = Pt(h.values)), (f = !t(h[0])) && (l *= l)) : (h = ib(h.increment))),
            Za(
                e,
                r ?
                s(h) ?
                ...
                function(e) {
                    for (
                        var r, i, n = parseFloat(f ? e.x : e), a = parseFloat(f ? e.y : 0), s = X, o = 0, u = h.length; u--;
                    )
            ...
            r.config.apply(
                ...
                [
                    (function _parseObjectInString(t) {
                        for (
                            var e, r, i, n = {}, a = t.substr(1, t.length - 3).split(":"), s = a[0], o = 1, u = a.length; o < u; o++
                        )
                            ((r = a[o]),
    ...
    function zl(t) {
        ...
        if (
            ((M < a || a < 0) && (P += a - C),
                (0 < (e = (i = (A += a) - P) - z) || s) &&
                ((n = ++g.frame), (b = i - 1e3 * g.time), (g.time = i /= 1e3), (z += e + (D <= e ? 4 : D - e)), (r = 1)),
                s || (p = _(zl)),
                r)
        )
    ...
    var Vt,
        ...
        (((Vt = Animation.prototype).delay = function delay(t) {
            ...
            (Vt.totalDuration = function totalDuration(t) {
                return arguments.length ?
                    ((this._dirty = 0), Ua(this, this._repeat < 0 ? t : (t - this._repeat * this._rDelay) / (this._repeat + 1))) :
                    this._tDur;
            }),
            ...
            (Vt.time = function time(t, e) {
                return arguments.length ?
                    this.totalTime(
                        Math.min(this.totalDuration(), t + Ha(this)) % (this._dur + this._rDelay) || (t ? this._dur : 0),
                        e
                    ) :
                    this._time;
            }),
            ...
            (Vt.progress = function progress(t, e) {
                return arguments.length ?
                    this.totalTime(this.duration() * (!this._yoyo || 1 & this.iteration() ? t : 1 - t) + Ha(this), e) :
                    this.duration() ?
            ...
            (Vt.revert = function revert(t) {
                ...
                return (
                    (I = t),
                    pa(this) && (this.timeline && this.timeline.revert(t), this.totalTime(-0.01, t.suppressEvents)),
            ...
            (Vt.isActive = function isActive() {
                var t,
                    ...
                    r = this._start;
                return !(
                    e && !(this._ts && this._initted && e.isActive() && (t = e.rawTime(!0)) >= r && t < this.endTime(!0) - q)
                );
            }),
        ...
        return (
            ...
            (e.getChildren = function getChildren(t, e, r, i) {
                ...
                for (var n = [], a = this._first; a;)
                    (a._start >= i &&
                        (a instanceof te ? e && n.push(a) : (r && n.push(a), t && n.push.apply(n, a.getChildren(!0, e, r)))),
                        (a = a._next));
                return n;
            }),
            ...
            (e.remove = function remove(t) {
                return r(t) ?
                    ...
                    s(t) ?
                    this.killTweensOf(t) :
                    (t.parent === this && Ba(this, t), t === this._recent && (this._recent = this._last), Da(this));
            }),
            (e.totalTime = function totalTime(t, e) {
                return arguments.length ?
                    ((this._forcing = 1),
                        !this._dp &&
                        this._ts &&
                        (this._start = la(It.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts))),
            ...
            (e.getTweensOf = function getTweensOf(e, r) {
                for (var i, n = [], a = Pt(e), s = this._first, o = t(r); s;)
                    (s instanceof te ?
                        na(s._targets, a) &&
                        (o ?
                            (!Zt || (s._initted && s._ts)) && s.globalTime(0) <= r && s.globalTime(s.totalDuration()) > r :
                            !r || s.isActive()) &&
                        n.push(s) :
        ...
        if (
            ...
            (u = new mt[t]()).init(
                ...
                (function _processVars(t, e, i, n, a) {
                    if ((s(t) && (t = Qt(t, a, e, i, n)), !v(t) || (t.style && t.nodeType) || K(t) || J(t)))
        ...
        $t = function _addPropTween(t, e, i, n, a, o, u, h, l, f) {
            ...
            if (
                ...
                return isNaN(p * n) || "" === n ?
                    ...
                    ((c = new we(this._pt, t, e, +p || 0, n - (p || 0), "boolean" == typeof d ? de : fe, 0, _)),
                        l && (c.fp = l),
            ...
            if (
                ...
                for (t._pt = t._ptCache = 0, T = (C && w(T)) || (T && !C), n = 0; n < S.length; n++) {
                    ...
                    (t._op && t._op[n] && t.kill(o, t._op[n]),
                        z && t._pt && ((Zt = t), L.killTweensOf(o, c, t.globalTime(e)), (_ = !t.parent), (Zt = 0)),
                        t._pt && T && (_t[h.id] = 1));
                }
                ...
                if (
                    ...
                    for (o = 0; o < h; o++)
                        (((u = xa(r, Kt)).stagger = 0),
                            ...
                            !b && 1 === h && u.delay && ((a._delay = m = u.delay), (a._start += m), (u.delay = 0)),
                    ...
                    if (
                        ...
                        ((l && l.render(t < 0 ? t : l._dur * l._ease(i / this._dur), e, r)) || (this._startAt && (this._zTime = t)),
                            ...
                            (p && !this._onUpdate && Fa(this, t, 0, !0),
                                (!t && d) || !((_ === this._tDur && 0 < this._ts) || (!_ && this._ts < 0)) || Ca(this, 1),
                                e ||
                                (p && !f) ||
                                !(_ || f || u) ||
                        ...
                        if (
                            (h &&
                                ...
                                ((l = Mt(0, t._tDur, e)),
                                    (a = wt(l, h)),
                                    t._yoyo && 1 & a && (u = 1 - u),
                                    a !== wt(t._tTime, h) && ((o = 1 - u), t.vars.repeatRefresh && t._initted && t.invalidate())),
                            ...
                            (e < 0 && Fa(t, e, 0, !0),
                                ...
                                (e >= t._tDur || e < 0) &&
                                t.ratio === u &&
                                (u && Ca(t, 1), r || I || (At(t, u ? "onComplete" : "onReverseComplete", !0), t._prom && t._prom())));
                            ...
                            for (c = t._ptCache[e] = [], l = t._ptLookup, f = t._targets.length; f--;) {
                                ...
                                if (!u)
                                    return (
                                        ...
                                        Ht(t, s),
                                        (Wt = 0),
                                        o ? T(e + " not eligible for reset. Try splitting into individual properties") : 1
                                    );
                                c.push(u);
                            }
                        for (f = c.length; f--;)
                ...
                for (
                    ...
                    if (~c.indexOf(f[l]))
                        for (u in ((a = d[l]),
                                ...
                                o))
                            ((h = a && a[u]) && (("kill" in h.d && !0 !== h.d.kill(u)) || Ba(this, h, "_pt"), delete a[u]),
                                "all" !== s && (s[u] = 1));
    ...
    var ie = function _setterPlain(t, e, r) {
        ...
        Te = function _killPropTweensOf(t) {
            for (var e, r, i = this._pt; i;)
                ((r = i._next), (i.p === t && !i.op) || i.op === t ? Ba(this, i, "_pt") : i.dep || (e = 1), (i = r));
            return !e;
        },
    ...
    function Od() {
        ...
        for (t = 0; t < r.length; t += 3)
            ...
            r[t + 2] ?
            (n[r[t]] = r[t + 2]) :
            n.removeProperty("--" === r[t].substr(0, 2) ? r[t] : r[t].replace(cr, "-$1").toLowerCase());
        if (this.tfm) {
            ...
            (a.svg && (a.renderTransform(), i.setAttribute("data-svg-origin", this.svgo || "")),
                ...
                n[mr] ||
                (Nd(n),
                    a.zOrigin && n[gr] && ((n[gr] += " " + a.zOrigin + "px"), (a.zOrigin = 0), a.renderTransform()),
                    (a.uncache = 1)));
        }
    }
    ...
    function ce(t, e, r, i) {
        ...
        if (
            ...
            return ((n = o ? t.getBBox()[f ? "width" : "height"] : t[d]), ka(_ ? (u / n) * 100 : (u / 100) * n));
        if (
            ((l[f ? "width" : "height"] = 100 + (p ? h : i)),
                (a = ("rem" !== i && ~e.indexOf("adius")) || ("em" === i && t.appendChild && !c) ? t : t.parentNode),
    ...
    function ee(t, e, r, i) {
        ...
        if (
            ((g.b = r),
                ...
                "auto" === i && ((f = t.style[e]), (t.style[e] = i), (i = Sd(t, e) || i), f ? (t.style[e] = f) : $d(t, e)),
                Ib((s = [r, i])),
                (i = s[1]),
                (u = (r = s[0]).match(nt) || []),
                (i.match(nt) || []).length)
    ...
    var Ie,
        ...
        wr = function _get(t, e, r, i) {
            ...
            return (
                ...
                ur[e] && "transform" !== e ?
                ((n = Cr(t, i)),
                    (n = "transformOrigin" !== e ? n[e] : n.svg ? n.origin : Pr(Sd(t, gr)) + " " + n.zOrigin + "px")) :
        ...
        Rr = function _renderCSSTransforms(t, e) {
            ...
            (_ !== Dr && (y += "perspective(" + _ + zr),
                (i || n) && (y += "translate(" + i + "%, " + n + "%) "),
                (!T && a === Dr && s === Dr && o === Dr) ||
                (y += o !== Dr || T ? "translate3d(" + a + ", " + s + ", " + o + ") " : "translate(" + a + ", " + s + zr),
                u !== Ar && (y += "rotate(" + u + zr),
                h !== Ar && (y += "rotateY(" + h + zr),
                l !== Ar && (y += "rotateX(" + l + zr),
        ...
        Er = function _renderSVGTransforms(t, e) {
            ...
            ((c = parseFloat(c)),
                ...
                (v || y || T || b) && ((x = ka(x + v - (v * r + y * n) + T)), (k = ka(k + y - (v * i + y * a) + b))),
                (u || h) && ((s = g.getBBox()), (x = ka(x + (u / 100) * s.width)), (k = ka(k + (h / 100) * s.height))),
            ...
            init: function init(t, e, i, n, a) {
                ...
                for (c in (Ne || Vd(), (this.styles = this.styles || Pd(t)), (b = this.styles.props), (this.tween = i), e))
                    ...
                    ((s = (getComputedStyle(t).getPropertyValue(c) + "").trim()),
                        (o += ""),
                        (Et.lastIndex = 0),
                        Et.test(s) || ((d = _a(s)), (p = _a(o)) ? d !== p && (s = ce(t, c, s, p) + p) : d && (o += d)),
                    ...
                    if (
                        (O && c in O ?
                            ...
                            ("autoAlpha" === c &&
                                (1 === h && "hidden" === wr(t, "visibility") && u && (h = 0),
                                    ...
                                    _d(this, k, "visibility", h ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)),
                                "scale" !== c && "transform" !== c && ~(c = _r[c]).indexOf(",") && (c = c.split(",")[0])),
                            (m = c in ur))
                    ) {
                        ...
                        if (
                            (g ||
                                (((v = t._gsap).renderTransform && !e.parseTransform) || Cr(t, e.parseTransform),
                                    (y = !1 !== e.smoothOrigin && v.smooth),
                                    ((g = this._pt = new we(this._pt, k, mr, 0, 1, v.renderTransform, v, 0, -1)).dep = 1)),
                                "scale" === c)
                        )
                            ((this._pt = new we(
                                    this._pt,
                            ...
                            if ("transformOrigin" === c) {
                                (b.push(gr, 0, k[gr]),
                                    ...
                                    v.svg ?
                                    oe(t, o, 0, y, 0, this) :
                                    ((p = parseFloat(o.split(" ")[2]) || 0) !== v.zOrigin && _d(this, v, "zOrigin", v.zOrigin, p),
                    ...
                    if (m || ((u || 0 === u) && (h || 0 === h) && !pr.test(o) && c in k))
                        ((u = u || 0),
                            (d = (s + "").substr((h + "").length)) !== (p = _a(o) || (c in Y.units ? Y.units[c] : d)) &&
                            (h = ce(t, c, s, p)),
                            (this._pt = new we(
                                this._pt,
                                m ? v : k,
