!(function(t, e) {
    ...
    n.prototype = {
        ...
        emit: function(t) {
            for (
                var e = [].slice.call(arguments, 1), i = ((this.e || (this.e = {}))[t] || []).slice(), o = 0, n = i.length; o < n; o++
            )
                ...
                t.exports = (function() {
                    ...
                    return (function() {
                        ...
                        return (
                            ...
                            (e._bind = function() {
                                (r.hasWheelEvent && i(this, h)[h].addEventListener("wheel", this._onWheel, this.listenerOptions),
                                    r.hasMouseWheelEvent &&
                                    i(this, h)[h].addEventListener("mousewheel", this._onMouseWheel, this.listenerOptions),
                                    r.hasTouch &&
                                    i(this, l)[l].useTouch &&
                                    (i(this, h)[h].addEventListener("touchstart", this._onTouchStart, this.listenerOptions),
                                        i(this, h)[h].addEventListener("touchmove", this._onTouchMove, this.listenerOptions)),
                                    r.hasPointer &&
                                    r.hasTouchWin &&
                                    ...
                                    r.hasKeyDown && i(this, l)[l].useKeyboard && document.addEventListener("keydown", this._onKeyDown));
                            }),
                            (e._unbind = function() {
                                (r.hasWheelEvent && i(this, h)[h].removeEventListener("wheel", this._onWheel),
                                    r.hasMouseWheelEvent && i(this, h)[h].removeEventListener("mousewheel", this._onMouseWheel),
                                    r.hasTouch &&
        ...
        function r(e) {
                        ...
                        o.ctrlKey ||
                            ...
                            ((r.smooth = o.changedTouches ? r.smoothTouch : r.options.smooth),
                                ...
                                (r.smooth && o.preventDefault(),
                                    (r.targetScroll -=
                                        "both" === r.gestureDirection ? i + e : "horizontal" === r.gestureDirection ? i : e),
                                    r.scrollTo(r.targetScroll)));
                    }
                }),
                (r.onScroll = function(t) {
                    (r.isScrolling && r.smooth) ||
                    ((r.targetScroll = r.scroll = r.lastScroll = r.wrapperNode[r.scrollProperty]), r.notify());
                }),
            ...
            return (
                (r.virtualScroll = new s({
                    ...
                    mouseMultiplier: r.mouseMultiplier * (P.includes("Win") || P.includes("Linux") ? 0.84 : 0.4),
